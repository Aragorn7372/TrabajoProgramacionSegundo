...
public abstract class BaseMongoRepositoryTest {
    ...
    private static final dev.luisvives.trabajoprogramacionsegundo.TestContainersConfig containers =
            dev.luisvives.trabajoprogramacionsegundo.TestContainersConfig.getInstance();
