 ...
 * @param <D> Tipo de respuesta para deleteById.
 * @param <ID> Tipo del identificador de la entidad.
 * @param <P> Tipo de objeto completo para save y update.
 * @param <PA> Tipo de objeto parcial para patch.
 */
public interface Service<R, D, ID, P, PA> {
     ...
     *
     * @param id Identificador del recurso a actualizar.
     * @param entity Objeto parcial con los campos a modificar.
     * @return El recurso actualizado parcialmente.
     */
