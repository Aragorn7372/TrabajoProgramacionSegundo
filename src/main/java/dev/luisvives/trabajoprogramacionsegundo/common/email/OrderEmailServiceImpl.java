...
public class OrderEmailServiceImpl implements OrderEmailService {
     ...
     * Actualmente reutiliza el método {@link #crearCuerpoEmailPedidoHtmlSimple(Pedido)} como base.
     * </p>
     *
     * @param pedido objeto {@link Pedido} que contiene los datos del pedido confirmado
     */
     ...
     * </p>
     *
     * @param pedido objeto {@link Pedido} con la información del pedido
     ...
     * <p>
     * Actualmente este método reutiliza el cuerpo generado por {@link #crearCuerpoEmailPedidoHtmlSimple(Pedido)}.
     * Se deja preparado para futuras mejoras de diseño o personalización.
     * </p>
     *
     * @param pedido objeto {@link Pedido} con los datos del pedido
